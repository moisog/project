...
def page_not_found(error):
    return render_template('errors/404.html'), 404 #200 estatus de exito
...
def login():
    ...
    if current_user.is_authenticated: #usurio actual
...
def register():
    if current_user.is_authenticated: # current_user = usuario actual
        return redirect (url_for('.tasks'))
